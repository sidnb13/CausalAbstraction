...
class CounterfactualDataset:
    ...
    def __init__(self, dataset: Dataset | None = None, id: str | None = "null"):
        """
        ...
        if dataset is not None:
            ...
            assert "input" in self.features  # type: ignore
            assert "counterfactual_inputs" in self.features  # type: ignore
    ...
    def add_column(self, column_name, column_data):
        ...
        self.dataset = self.dataset.add_column(column_name, column_data)  # type: ignore
    ...
    def remove_column(self, column_name):
        ...
        """
        self.dataset = self.dataset.remove_columns(column_name)  # type: ignore
